<?php
	...
	$itemCount = $subscriptionItems->getCountForSubscription($id);
	$irows = $subscriptionItems->getGroupedRowsForSubscription($id, 0, $itemCount);
	...
	$response = ["result"=>"OK", "subscription"=>$row, "subscription_items"=>$irows];
